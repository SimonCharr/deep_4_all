# Compte Rendu TP2 - Partie 3 : Oracle du Donjon (Sequences)
...
**Dataset** :
- Train : 14 000 sequences
- Validation : 3 000 sequences
- Vocabulaire : 45 tokens
- Longueur : min=2, max=109, moyenne=35
...
```
tp2/
├── baseline_model.py               # DungeonOracle (Linear/RNN/LSTM/Transformer)
├── train_dungeon_logs.py           # Script d'entrainement optimise
├── run_experiments.py              # Script de recherche d'hyperparametres
├── checkpoints/
│   ├── best_dungeon_model.pt       # Meilleur modele Transformer
│   ├── best_tf_32_64_2L_4h.pt     # Transformer compact (BEST)
│   ├── best_tf_32_128_2L_4h.pt    # Test hidden=128
│   ├── best_tf_32_64_3L_4h.pt     # Test 3 couches
│   ├── best_tf_48_96_2L_8h.pt     # Test large embeddings
│   ├── dungeon_history.json        # Historique train/val
│   └── dungeon_training_curves.png # Courbes d'apprentissage
```
